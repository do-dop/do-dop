# 박도연 | Backend · DevOps Engineer

[Tech Blog](https://velog.io/@pdy0207) 
...
- **주인장** · 부동산 임장 기록 및 매물 비교 서비스 - iOS `(2023.09 – 2024.02)`

---

## Activities
- **2026 오픈소스 컨트리뷰션 아카데미** · 정보통신산업진흥원 `(2026.04.20 – 2026.06.02)`
  - Git 활용 및 LitmusChaos 오픈소스 프로젝트 참여
- **Cloud Club 9기** `(2026.03 – 2026.06)`
- **CMC 16기 Server** `(2024.11 – 2025.02)`
- **UMC 6기 홍익대학교 회장** `(2024.03 – 2024.08)`
- **홍익대학교 공과대학 학생회 사무국** `(2023.02 – 2024.02)`
- **UMC 5기 iOS Challenger** `(2023.09 – 2024.02)`

---

## Education

- **홍익대학교 컴퓨터공학과** `(2022.03 – 현재)`
  - 2027년 2월 졸업 예정
...
- **CMC 16기 데모데이 최우수상** · PATATA `(2025)`
- **UMC 5기 데모데이 3등** · 주인장 `(2024)`
...
![OAuth 2.0](https://img.shields.io/badge/OAuth_2.0-3C3C3D?style=flat-square)
...
![YOLO](https://img.shields.io/badge/YOLO-111F68?style=flat-square&logoColor=white)
